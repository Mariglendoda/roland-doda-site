...
const recommendations = ref([
  ...
  {
    image:
      "https://media-exp1.licdn.com/dms/image/C4D03AQGltbmnkvu34Q/profile-displayphoto-shrink_100_100/0/1659043027952?e=1669852800&v=beta&t=LBIDy3C7n7EysOxfQu4JAT4INqAdkEnr5_sIu1AJnkc",
    fullName: "Klodia Shaba",
  ...
  <div id="testimonials">
    <div class="relative grid gap-[30px] max-h-[1240px] overflow-hidden">
      ...
      <div class="grid grid-cols-3 gap-[20px]">
        <div class="grid gap-[20px] content-start max-w-[400px]">
          <div
            class="grid gap-[10px] bg-glassmorphism p-4 rounded-[20px]"
            v-for="recommendation of recommendations.slice(0, 4)"
          >
            <div class="flex items-center gap-[15px]">
              ...
              <div>
                <div class="description">{{ recommendation.fullName }}</div>
                <div class="subtitle">{{ recommendation.job }}</div>
              </div>
            </div>
        ...
        <div class="grid gap-[20px] content-start max-w-[400px]">
          <div
            class="grid gap-[10px] bg-glassmorphism p-4 rounded-[20px]"
            v-for="recommendation of recommendations.slice(4, 7)"
          >
            <div class="flex items-center gap-[15px]">
              <div
                class="img w-[50px] h-[50px] rounded-full bg-cover"
        ...
        <div class="grid gap-[20px] content-start max-w-[400px]">
          <div
            class="grid gap-[10px] bg-glassmorphism p-4 rounded-[20px]"
            v-for="recommendation of recommendations.slice(6)"
          >
            <div class="flex items-center gap-[15px]">
              <div
                class="img w-[50px] h-[50px] rounded-full bg-cover"
      ...
      <div class="absolute bottom-0 w-full grid justify-center content-center">
        <div class="absolute bottom-0 w-full h-[250px] bg-testimonial"></div>
